...
class PageDetailDaerah extends StatefulWidget {
  final String link;
  const PageDetailDaerah({Key? key, required this.link}) : super(key: key);

  @override
  State<PageDetailDaerah> createState() => _PageDetailDaerahState();
}

class _PageDetailDaerahState extends State<PageDetailDaerah> {
  @override
